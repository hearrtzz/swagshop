...
const oldBlock = `        {/* ================= TAB: FX (GLOW, HALFTONE, LIMIAR) ================= */}
        {activeTab === 'fx' && (
...
const newBlock = `        {/* ================= TAB: FX (GLOW, HALFTONE, LIMIAR) ================= */}
        {activeTab === 'fx' && (
...
if (content.includes(oldBlock)) {
  ...
  console.log("Success FX Tab Replace!");
} else {
  console.log("Failed to match fx tab block.");
}
